...
<p>
    ...
    <img alt="Project version" src="https://img.shields.io/badge/version-v0.1.0-black?style=flat-square&logo=python&logoColor=fff"></img></a>
</p>
...
print(config.password.get()) # Output: 12345678
```
